...
%% read data
data = importdata('sqw_powder.dat',' ',1);
...
xlabel('Q (1/\AA)', 'Interpreter', 'latex','FontName','times new roman','FontWeight','Bold', 'FontSize', 8);
ylabel('Energy (meV)','FontName','times new roman','FontWeight','Bold', 'FontSize', 8);
