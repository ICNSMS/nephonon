...
line([x(500), x(500)], [0,max(y)], 'LineStyle', '-', 'LineWidth', 2.0);

set(gca, 'XTick', [0.0,x(200), x(300), x(400), x(500), max(x)]);
set(gca, 'XTickLabel', {'\Gamma', 'X', 'K', '\Gamma', 'L', 'W'});

ylabel('Energy (meV)');
title('Band Structure of PbTe');
grid on;
grid minor;  % 可选，显示细网格
